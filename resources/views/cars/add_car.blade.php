...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("
        ...
        (full_name, phone, email, car_make, car_model, car_year, car_color, license_plate, vin, car_condition, mileage, location, password)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ");
    $stmt->execute([$full_name, $phone, $email, $car_make, $car_model, $car_year, $car_color, $license_plate, $vin, $car_condition, $mileage, $location, $password]);
