...
<head>
    ...
    <title>Emergency Cars - Premium Rental Experience</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body class="bg-gradient-sunset">
    ...
    <!-- Header Section -->
    <div class="header">
        <h1>🚗 EMERGENCY Cars</h1>
        <p class="tagline">GET YOUR VEHICLE INSTANTLY</p>
    ...
    <script>
        ...
        async function loadCars() {
            try {
                ...
                const response = await fetch('http://127.0.0.1:8000/test-categories3');
                if (!response.ok) {
