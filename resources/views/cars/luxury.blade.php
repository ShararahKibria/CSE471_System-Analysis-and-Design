...
<head>
    ...
    <title>Luxury Cars - Premium Rental Experience</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body class="bg-gradient-sunset">
    ...
    <div class="header">
        <h1>🚗 LUXURY Cars</h1>
        <p class="tagline">Experience the Freedom of Premium Luxury Travel</p>
    ...
    <script>
        ...
        function confirmOrder() {
            ...
            alert(`🎉 Order Confirmed!\n\nPayment Method: ${paymentMethod.toUpperCase()}\nTotal Cars: ${cart.length}\nThank you for choosing PREMIUM Cars!`);
        ...
        async function loadCars() {
            try {
                ...
                const response = await fetch('http://127.0.0.1:8000/test-categories1');
                if (!response.ok) {
